        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <main class="col-md-10 ms-sm-auto p-4">
                    ...
                    <div class="row g-3 mb-4">
                        <div class="col-md-4">
                            <div class="card shadow-sm border-0">
                                <div class="card-body text-center">
                                    <i
                                        class="bi bi-people-fill text-warning fs-2 mb-2"
                                    ></i>
                        ...
                        <div class="col-md-4">
                            <div class="card shadow-sm border-0">
                                <div class="card-body text-center">
                                    <i
                                        class="bi bi-person-badge text-success fs-2 mb-2"
                                    ></i>
                        ...
                        <div class="col-md-4">
                            <div class="card shadow-sm border-0">
                                <div class="card-body text-center">
                                    <i
                                        class="bi bi-person-workspace text-primary fs-2 mb-2"
                                    ></i>
                    ...
                    >
                        <div class="modal-dialog">
                            <form
                                method="POST"
                                action="{{
                                    route('kepegawaian.export.data.pegawai')
                                }}"
                            >
                                @csrf
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        @php $fields = [ 'user_id' => 'ID',
                                        'user_nip' => 'NIP', 'user_nama' =>
                                        'Nama', 'user_nik' => 'NIK',
                    ...
                    <div
                        class="modal fade"
                        id="modalDetailAll{{ $user->user_id }}"
                        tabindex="-1"
                        aria-labelledby="modalDetailAllLabel{{ $user->user_id }}"
                        aria-hidden="true"
                    >
                        <div
                        ...
                        >
                            <div class="modal-content">
                                <div class="modal-header bg-dark text-white">
                                    <h5
                                        class="modal-title"
                                        id="modalDetailAllLabel{{ $user->user_id }}"
                                    >
                                        Detail Pegawai
                                    </h5>
                                    <button
