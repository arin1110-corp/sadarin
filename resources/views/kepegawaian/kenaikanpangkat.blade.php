            ...
            <main class="col-md-10 ms-sm-auto p-4">
                ...
                <div class="d-flex justify-content-between align-items-center mb-4 border-bottom pb-3">
                    <h2 class="fw-bold text-primary">
                        <i class="bi bi-speedometer2 me-2"></i> Dashboard Kenaikan Pangkat
                    </h2>
                ...
                <div class="mb-4">
                    <h3 class="fw-bold text-center text-secondary">
                        <i class="bi bi-bar-chart me-2"></i> Jumlah Kenaikan Pangkat Tahun 2025
                    </h3>
                </div>
                    ...
                    <div class="col-md-2">
                        <div class="card shadow-sm border-0">
                            <div class="card-body text-center">
                                ...
                                <p class="display-6 fw-bold text-danger">{{ $kpBulanIni }}</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="card shadow-sm border-0">
                            <div class="card-body text-center">
                                ...
                                <p class="display-6 fw-bold text-warning">{{ $kpBulanDepan }}</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="card shadow-sm border-0">
                            <div class="card-body text-center">
                                ...
                                <p class="display-6 fw-bold text-primary">{{ $kp3Bulan }}</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="card shadow-sm border-0">
                            <div class="card-body text-center">
                                ...
                                <p class="display-6 fw-bold text-info">{{ $kp6Bulan }}</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="card shadow-sm border-0 bg-danger text-white">
                            <div class="card-body text-center">
                                ...
                                <p class="display-6 fw-bold">{{ $listKp2025->count() }}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-2">
                        <div class="card shadow-sm border-0 bg-dark text-white">
                            <div class="card-body text-center">
                                ...
                                <p class="display-6 fw-bold">{{ $listKp2026->count() }}</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card shadow-sm border-0 mb-4">
                    <div class="card-body">
                        <h5 class="fw-bold mb-3">
                            <i class="bi bi-people-fill me-2"></i>Daftar Pegawai Kenaikan Pangkat 1 Tahun ke Depan
                        </h5>
                        <table id="tableKp" class="table table-striped table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $pegawai->jabatan_kategori }}</td>
                                    <td>{{ $pegawai->user_jeniskerja == '1' ? 'PNS' : ($pegawai->user_jeniskerja == '2' ? 'PPPK' : '-') }}
                                    </td>
                                    <td data-order="{{ \Carbon\Carbon::parse($pegawai->tanggal_kp)->format('Y-m-d') }}">
                                        {{ \Carbon\Carbon::parse($pegawai->tanggal_kp)->translatedFormat('d F Y') }}
                                    </td>
                                    <td>
                                        <button class="btn btn-sm btn-outline-primary" data-bs-toggle="modal"
                                            data-bs-target="#modalDetailKp{{ $pegawai->id }}">
                ...
                {{-- Modals --}}
                @foreach ($daftarKp as $pegawai)
                <div class="modal fade" id="modalDetailKp{{ $pegawai->id }}" tabindex="-1"
                    aria-labelledby="modalDetailKpLabel{{ $pegawai->id }}" aria-hidden="true">
                    <div class="modal-dialog modal-lg modal-dialog-centered">
                        <div class="modal-content">
                            <div class="modal-header bg-success text-white">
                                <h5 class="modal-title" id="modalDetailKpLabel{{ $pegawai->id }}">Detail Pegawai</h5>
    ...
    <script>
        $(document).ready(function() {
            $('#tableKp').DataTable({
                "order": [
                    [5, "asc"]
                ] // urutkan ASC berdasarkan kolom ke-6 (Tanggal KP)
            });
        });
    </script>
</body>
