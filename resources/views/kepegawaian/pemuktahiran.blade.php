                    ...
                    <div class="col-md-3">
                        <div class="card shadow-sm border-0">
                            <div class="card-body text-center">
                                ...
                                <h6 class="fw-semibold">Total Pegawai Mengajukan Pemuktahiran</h6>
                                <p class="display-6 fw-bold text-success">{{ @$totalPegawaiPemuktahiran }}</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="card shadow-sm border-0">
                            <div class="card-body text-center">
                                ...
                                <p class="display-6 fw-bold text-dark">{{ @$datapnspegawai }}</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
