        ...
        <main class="main">
            ...
            <div class="topbar d-flex flex-wrap justify-content-between align-items-center gap-3">
                ...
                <div class="d-flex flex-wrap gap-2">
                    ...
                    <button class="btn btn-warning btn-rounded" data-bs-toggle="modal"
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-md-3">
                            <div class="card-soft p-4">
                                ...
                                <h5 class="fw-bold mt-2">{{ $jenisKerja[$user->user_jeniskerja] ?? 'Tidak Diketahui' }}
                                </h5>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="card-soft p-4">
                                ...
                                <h5 class="fw-bold mt-2">
                                    {{ $user->golongan_nama }}
                                    {{ $user->golongan_pangkat ? '(' . $user->golongan_pangkat . ')' : '' }}
                                </h5>
                            </div>
                        </div>
                ...
                <section id="section-pegawai" class="content-section d-none">
                    <div class="card-soft p-4">
                        ...
                        <div class="info-row">
                            ...
                            <div>{{ $user->user_jk == 'L' ? 'Laki-laki' : 'Perempuan' }}</div>
                        </div>
                        <div class="info-row">
                        ...
                        <div class="info-row">
                            ...
                            <div>{{ $user->user_notelp }}</div>
                        </div>
                        <div class="info-row">
                            <div class="info-label">Tempat dan Tanggal Lahir</div>
                            <div>{{ $user->user_tempatlahir }},
                                {{ \Carbon\Carbon::parse($user->user_tgllahir)->translatedFormat('j F Y') }}</div>
                        </div>
                        <div class="info-row">
                            <div class="info-label">Alamat</div>
                            <div>{{ $user->user_alamat }}</div>
                        </div>
                    </div>
                </section>
                ...
                <section id="section-kepegawaian" class="content-section d-none">
                    <div class="card-soft p-4">
                        ...
                        <div class="info-row">
                            ...
                            <div>{{ $user->user_nip }}</div>
                        </div>
                        <div class="info-row">
                            <div class="info-label">Golongan</div>
                            <div>{{ $user->golongan_nama }} ({{ $user->golongan_pangkat }})</div>
                        </div>
                        <div class="info-row">
                            <div class="info-label">Kelas Jabatan</div>
                            <div>Kelas Jabatan {{ $user->user_kelasjabatan }}</div>
                        </div>
                        <div class="info-row">
                            <div class="info-label">Bidang</div>
                            <div>{{ $user->bidang_nama }}</div>
                        </div>
                        <div class="info-row">
                            <div class="info-label">Eselon</div>
                            <div>{{ $user->eselon_nama }}</div>
                        </div>
                        <div class="info-row">
                            <div class="info-label">Jabatan</div>
                            <div>{{ $user->jabatan_nama }}</div>
                        </div>
                        <div class="info-row">
                            <div class="info-label">TMT</div>
                            <div>{{ \Carbon\Carbon::parse($user->user_tmt)->translatedFormat('j F Y') }}</div>
                        </div>
                        <div class="info-row">
                            <div class="info-label">SPMT</div>
                            <div>{{ \Carbon\Carbon::parse($user->user_spmt)->translatedFormat('j F Y') }}</div>
                        </div>
                        <div class="info-row">
                            <div class="info-label">Lokasi Tempat Kerja</div>
                            <div>{{ $user->user_lokasikerja }}</div>
                        </div>
                        <div class="info-row">
                            <div class="info-label">Jenis Kerja</div>
                            <div>{{ $jenisKerja[$user->user_jeniskerja] ?? 'Tidak Diketahui' }}</div>
                        </div>
                    </div>
                </section>
                ...
                <section id="section-pendidikan" class="content-section d-none">
                    <div class="card-soft p-4">
                        ...
                        <div class="info-row">
                            ...
                            <div>{{ $user->pendidikan_jenjang }} - {{ $user->pendidikan_jurusan }}</div>
                        </div>
                        <div class="info-row">
                            <div class="info-label">Gelar Depan</div>
                            <div>{{ $user->user_gelardepan }}</div>
                        </div>
                        <div class="info-row">
                            <div class="info-label">Gelar Belakang</div>
                            <div>{{ $user->user_gelarbelakang }}</div>
                        </div>
                    </div>
                </section>
                ...
                <section id="section-penggajian" class="content-section d-none">
                    <div class="card-soft p-4">
                        ...
                        <div class="info-row">
                            ...
                            <div>{{ $user->user_jmltanggungan }} Orang</div>
                        </div>
                        <div class="info-row">
                            <div class="info-label">Nomor NPWP</div>
                            <div>{{ $user->user_npwp }}</div>
                        </div>
                        <div class="info-row">
                            <div class="info-label">Nomor BPJS Kesehatan</div>
                            <div>{{ $user->user_bpjs }}</div>
                        </div>
                        <div class="info-row">
                            <div class="info-label">Nomor Rekening</div>
                            <div>{{ $user->user_norek }}</div>
                        </div>
                        <div class="info-row">
                            <div class="info-label">Status</div>
                            <div>{{ $user->user_status == 1 ? 'Aktif' : 'Non-Aktif' }}</div>
                        </div>
                    </div>
                </section>
                            ...
                            <div class="mb-4">
                                ...
                                <div class="berkas-grid">
                                    @foreach ($items as $tombol)
                                        <button
                                            class="btn btn-{{ cekBerkas($berkas, $tombol->tombol_nama) }} btn-rounded showFiles"
                                            data-jenis="{{ $tombol->tombol_nama }}">
            ...
            {{-- Banner Affilio --}}
            <div class="footer-affilio">
                <center>Ads
                    <a href="https://affilio.store" target="_blank">
                        <img src="{{ asset('assets/image/affilio.png') }}" alt="Affilio">
                    </a>
                </center>
            </div>
        </main>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="user_lokasikerja" class="form-select">
                                <option value="{{ $user->user_lokasikerja }}" selected>{{ $user->user_lokasikerja }}
                                </option>
                                <option value="Kantor Dinas Kebudayaan Provinsi Bali">Kantor Dinas Kebudayaan Provinsi
                                    Bali</option>
            ...
            <div class="modal-content">
                <form action="{{ route('pemuktahiran.update.pasfoto') }}" method="POST"
                    ...
                    <div class="modal-body">
                        ...
                        <div class="alert alert-warning">
                            <div class="fw-bold mb-2">Ketentuan warna latar belakang foto ukuran 4x6, wajib baju keki:
                            </div>
                            <ul class="mb-0">
    ...
    <script>
        document.querySelectorAll('.menu-link').forEach(menu => {
            menu.addEventListener('click', function() {
                ...
                document.querySelectorAll('.content-section').forEach(section => section.classList.add(
                    'd-none'));
