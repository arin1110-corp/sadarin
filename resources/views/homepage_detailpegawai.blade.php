...
<html lang="en">
    <head>
        ...
        <meta
            name="description"
            content="Sistem Data dan Arsip Internal - SADARIN"
        />
        <meta
            name="keywords"
        ...
        <link
            rel="icon"
            href="{{ asset('assets/image/pemprov.png') }}"
            type="image/x-icon"
        />
        <!-- Bootstrap -->
        <link
    ...
    <body class="d-flex flex-column min-vh-100 bg-light">
                        ...
                        <div class="card shadow-sm p-4">
                            ...
                            >
                                <div class="d-flex gap-2">
                                    ...
                                    >
                                        <i class="bi bi-plus-lg"></i> Evaluasi
                                    ...
                                    >
                                        <i class="bi bi-plus-lg"></i> Rekaman
                                        Umpan Balik Triwulan III
                                    </button>
                                </div>
                            </div>
                            <hr />
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-sm-8">
                                    Kelas Jabatan {{ $user->user_kelasjabatan }}
                                </div>
                            </div>
                            <div class="row mb-2">
                            ...
                            <hr />
                            <hr />
                            @php // Fungsi lokal untuk cek status berkas
                            $cekBerkas = function ($berkas, $jenis) { $data =
                            $berkas->firstWhere('kumpulan_jenis', $jenis); if
                            (!$data) return 'secondary'; // belum ada di tabel
                            return $data->kumpulan_status == 1 ? 'success' :
                            'secondary'; // hijau kalau status 1 }; @endphp
                                ...
                                <div class="col-sm-6">
                                    <button
                                        class="btn btn-{{
                                            cekBerkas(
                                                $berkas,
                                                'Umpan Balik Triwulan I'
                                            )
                                        }} showFiles"
                                        data-jenis="Umpan Balik Triwulan I"
                                    >
                                        TW I
                                    </button>
                                    <button
                                        class="btn btn-{{
                                            cekBerkas(
                                                $berkas,
                                                'Umpan Balik Triwulan II'
                                            )
                                        }} showFiles"
                                        data-jenis="Umpan Balik Triwulan II"
                                    >
                                        TW II
                                    </button>
                                    <button
                                        ...
                                        data-jenis="Umpan Balik Triwulan III"
                                    >
                                        TW III
                                    </button>
                                    <button
                                        class="btn btn-{{
                                            cekBerkas(
                                                $berkas,
                                                'Umpan Balik Triwulan IV'
                                            )
                                        }} showFiles"
                                        data-jenis="Umpan Balik Triwulan IV"
                                    >
                                        TW IV
                                    </button>
                                </div>
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-sm-6">
                                    <button
                                        class="btn btn-{{
                                            cekBerkas($berkas, 'Model C 2025')
                                        }} showFiles"
                                        data-jenis="Model C 2025"
                                    >
                                        2025
                                    </button>
                                </div>
        ...
        <div
            class="modal fade"
            id="tambahEvaluasiModal"
            tabindex="-1"
            aria-labelledby="tambahEvaluasiModalLabel"
            aria-hidden="true"
        >
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <form
                        action="{{ route('tambah.evaluasi.tw3') }}"
                        method="POST"
                    ...
                    >
                        ...
                        <div class="modal-header">
                            <h5
                                class="modal-title"
                                id="tambahEvaluasiModalLabel"
                            >
                                Tambah Evaluasi Kinerja Triwulan III
                            </h5>
                            <button
                                type="button"
                                class="btn-close"
                        ...
                        <div class="modal-body">
                            <div class="mb-3">
                                <label class="form-label"
                                    >Evaluasi Kinerja Triwulan III</label
                                >
                                <input
                                    type="file"
                                    name="file"
                            ...
                            <input
                                type="hidden"
                                name="kumpulan_jenis"
                                value="Evaluasi Kinerja Triwulan III"
                            />
                            <input
                                type="hidden"
                                name="user_jeniskerja"
                                value="{{ $user->user_jeniskerja }}"
                            />
                            <input
                                type="hidden"
                                name="jenisfile"
        ...
        <div
            class="modal fade"
            id="tambahUmpanBalikModal"
            tabindex="-1"
            aria-labelledby="tambahUmpanBalikModalLabel"
            aria-hidden="true"
        >
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <form
                        action="{{ route('tambah.umpanbalik.tw3') }}"
                        method="POST"
                        enctype="multipart/form-data"
                    >
                        @csrf
                        ...
                        <div class="modal-header">
                            <h5
                                class="modal-title"
                                id="tambahUmpanBalikModalLabel"
                            >
                                Tambah Umpan Balik Triwulan III
                            </h5>
                            <button
                                type="button"
                                class="btn-close"
                        ...
                        <div class="modal-body">
                            <div class="mb-3">
                                <label class="form-label"
                                    >Umpan Balik Triwulan III</label
                                >
                                <input
                                    type="file"
                                    name="file"
                            ...
                            <input
                                type="hidden"
                                name="kumpulan_jenis"
                                value="Umpan Balik Triwulan III"
                            />
                            <input
                                type="hidden"
                                name="user_jeniskerja"
        ...
        >
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <form
                        action="{{ route('pemuktahiran.update.pasfoto') }}"
                        method="POST"
                        enctype="multipart/form-data"
                    >
                        @csrf
                        ...
                        />
                        <div class="modal-header">
                            <h5 class="modal-title" id="editPegawaiModalLabel">
                                Edit Pas Foto Pegawai
                            </h5>
                            <button
                                type="button"
                                class="btn-close"
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                ...
                                @if($user->user_foto != '-' && $user->user_foto
                                != null)
                                <img
                                    src="{{ asset($user->user_foto) }}"
                                    alt="Foto Pegawai"
                                    class="mt-2"
                                    style="
                                        width: 100px;
                                ...
                                <div class="mt-3">
                                    <small class="text-danger fw-bold"
                                        >* Ketentuan warna latar belakang foto
                                        (wajib baju keki) ukuran 4x6 :</small
                                    >
        ...
        >
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <form
                        action="{{ route('pemuktahiran.update') }}"
                        method="POST"
                        enctype="multipart/form-data"
                    >
                        @csrf
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row mb-3">
                                <div class="col">
                                    <label class="form-label"
                                        >Gelar Depan (jika tidak isikan
                                        "-")</label
                                    >
                                    <input
                                        type="text"
                                        name="user_gelardepan"
                                        class="form-control"
                                ...
                                <div class="col">
                                    <label class="form-label"
                                        >Gelar Belakang (jika tidak isikan
                                        "-")</label
                                    >
                                    <input
                                        type="text"
                                        name="user_gelarbelakang"
                                        class="form-control"
                            ...
                            <div class="row mb-3">
                                <div class="col">
                                    ...
                                    >
                                        ...
                                        <option
                                            value="{{ $pendidikan->pendidikan_id }}"
                                            {{
                                            $user-
                                        >
                                            user_pendidikan ==
                            ...
                            <div class="row mb-3">
                                <div class="col">
                                    ...
                                    >
                                        ...
                                        <option
                                            value="{{ $golongan->golongan_id }}"
                                            {{
                                            $user-
                                        >
                                            user_golongan ==
                                            $golongan->golongan_id ? 'selected'
                                            : '' }}>
                                ...
                                <div class="col">
                                    ...
                                    >
                                        <option
                                            value="{{ $user->user_eselon }}"
                                        >
                                            {{ $user->eselon_nama }}
                                        </option>
                                        @foreach($eselons as $eselon)
                                        <option
                                            value="{{ $eselon->eselon_id }}"
                                            {{
                                            $user-
                                        >
                                            user_eselon == $eselon->eselon_id ?
                                            'selected' : '' }}>
                                            {{ $eselon->eselon_nama }}
                                        </option>
                                        @endforeach
                            ...
                            <div class="row mb-3">
                                <div class="col">
                                    ...
                                    <input
                                        type="number"
                                        name="user_jmltanggungan"
                                        class="form-control"
                                        value="{{ $user->user_jmltanggungan }}"
                                    />
                                    Orang
                                </div>
                                <div class="col">
                            ...
                            <div class="row mb-3">
                                ...
                                <input
                                    type="text"
                                    class="form-control"
                                    value="{{ $user->user_jeniskerja == 1 ? 'PNS' : 'PPPK' }}"
                                    disabled
                                />
                                <input
                                    type="hidden"
        ...
        <div
            class="modal fade"
            id="pemuktahiranPegawaiModal"
            tabindex="-1"
            aria-labelledby="pemuktahiranPegawaiModal"
            aria-hidden="true"
        >
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="pemuktahiranModalLabel">
                            Pemuktahiran
                        </h5>
                        <button
                            type="button"
        ...
        <footer class="text-center py-4 px-3 bg-light small text-muted">
            ...
            <strong>SADARIN</strong>. All rights reserved.
            <span class="text-danger">|</span>
            <span class="text-dark">Crafted by <strong>ARIN</strong></span>
            <span class="text-muted"
                >with Pranata Komputer Ahli Pertama
        ...
        <script>
            $(document).ready(function () {
                // Untuk Jabatan
                $('select[name="jabatan_id"]').select2({
                    dropdownParent: $("#pemuktahiranPegawaiModal"),
                    width: "100%",
                });
