...
<body>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <table id="tabelBidang" class="table table-striped table-bordered w-100">
                            ...
                            <tbody>
                                @foreach ($bidangs as $no => $b)
                                <tr>
                                    <td>{{ $no+1 }}</td>
                                    <td>{{ $b->bidang_nama }}</td>
                                    <td>{{$b->bidang_link}}</td>
                                    <td>
                                        @if($b->bidang_status == '1')
    ...
    <div class="modal fade" id="modalTambah" tabindex="-1" aria-labelledby="modalTambahLabel" aria-hidden="true">
        <div class="modal-dialog">
            <form action="{{ route('bidang.simpan') }}" method="POST">
                @csrf
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="bidang_nama" required>
                        </div>
                        <div class="mb-3">
                            <label>Link Bidang</label>
                            <input type="text" class="form-control" name="bidang_link" required>
                        </div>
                        <div class="mb-3">
                            <label>Status</label>
                            <select class="form-select" name="bidang_status" required>
