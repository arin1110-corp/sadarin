<nav class="col-md-2 d-none d-md-block sidebar p-3">
    ...
    <ul class="nav flex-column">
        ...
        <li class="nav-item mb-2">
            <a class="nav-link" href="{{ route('admin.navigasi') }}"><i class="bi bi-chat-square-quote"></i>
                Navigasi</a>
        </li>
        <li class="nav-item mb-2">
        ...
        <li class="nav-item mb-2">
            <a class="nav-link" href="{{ route('admin.mappingtombol') }}"><i class="bi bi-folder-fill"></i> Mapping
                Tombol</a>
        </li>
        <li class="nav-item mb-2">
            <a class="nav-link" href="{{ route('admin.json') }}"><i class="bi bi-file-earmark-code-fill"></i> JSON</a>
        </li>
    </ul>
</nav>
